...
ارسال ایمیل نیز از تنظیمات قابل فعال‌سازی است و برای اطلاعات ورود پرتال، پاسخ تیکت و یادآوری فعالیت استفاده می‌شود. این قابلیت به فعال بودن تابع `mail()` در PHP هاست وابسته است.
